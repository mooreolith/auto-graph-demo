...
export default class RadialMenu {
	 ...
	 */
	constructor(elem, {fontFamily, fontSize, innerCircle, outerCircle,
	...
	addEvent(){
		...
		this.canvas.addEventListener('click', this.oncanvasclicked.bind(this));
